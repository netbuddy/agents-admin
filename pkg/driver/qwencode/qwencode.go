...
func mapEventType(eventType string, raw map[string]interface{}) driver.EventType {
	switch eventType {
	case "system":
	...
	case "tool_result":
		return driver.EventToolResult
	case "file_read":
		return driver.EventFileRead
	case "file_write":
		return driver.EventFileWrite
	case "shell", "command":
		return driver.EventCommand
	case "shell_output", "command_output", "command_done":
		return driver.EventCommandOutput
	case "error":
